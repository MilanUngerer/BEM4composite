...
nc = np.sqrt((1.j*cci*mui)/(omega*e0*mu0))
alfa_m = mue/mu0
alfa_c = mui/mue
antena = np.array(*)
...
op_m[1,1] = op_m[1,1] + 0.5 * ident_m * ((1-alfa_m)/alfa_m)
op_0[1,1] = op_0[1,1] + 0.5 * ident_0* (1-alfa_c)
op_1[1,1] = op_1[1,1] + 0.5 * ident_1* (1-alfa_c)
